...
export default function VideoClassPageClient({ data }: { data: ApiResponse<Course> }) {
  console.log(data)
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="details">
          <Card>
            ...
            <CardContent>
              <CreateCourseForm format="video" data={data.data} />
            </CardContent>
          </Card>
        </TabsContent>
                      ...
                      {selectedWeekIndex !== null && (
                        <>
                          <div className="flex justify-between items-center mb-4">
                            ...
                            <Button type="button" variant="outline" size="sm" onClick={() => addDay(selectedWeekIndex)}>
