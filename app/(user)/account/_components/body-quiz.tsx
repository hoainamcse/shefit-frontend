    ...
    <div>
      ...
      <div className="py-20 px-[60px]">
        ...
        <div className="flex flex-col gap-[18px]">
          <Button className="justify-between bg-background border border-[#E2E2E2] shadow-none text-[#000000] h-[54px] ">
            <span className="text-[20px] leading-[30px]">Kết quả ngày 7/3/2025</span>{" "}
            <RightArrowIcon stroke="#8E8E93" />
          </Button>
