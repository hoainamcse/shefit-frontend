...
export function CoachCard({ coach, reverse = false }: CoachCardProps) {
  return (
    <div className="flex items-center justify-between">
      <div className={`flex max-sm:flex-col items-center lg:gap-20 gap-8 ${reverse ? 'flex-row-reverse' : ''}`}>
        ...
        <div className="bg-primary max-sm:bg-white xl:text-4xl lg:text-2xl text-gray-500 rounded-[55px] xl:p-10 lg:p-10 md:p-8 sm:p-6 max-sm:text-base max-sm:w-full">
          {coach.description}
        </div>
      </div>
    </div>
