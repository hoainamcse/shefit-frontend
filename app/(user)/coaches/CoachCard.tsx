    ...
    <div>
        ...
        >
          <div className="flex-1 flex flex-col items-center text-center justify-center gap-7 md:gap-1 w-full max-w-[340px]">
            ...
            <div className="w-full block md:hidden">
              <p className="font-semibold text-lg mb-1 md:mb-2">{coach.name}</p>
              <p className="text-gray-500 text-xs md:text-sm lg:text-lg text-center">{coach.detail}</p>
            </div>
          </div>
      ...
      <div className="hidden md:flex mt-1">
        ...
        >
          ...
          <div className="flex-[2] xl:px-16 lg:px-10 md:px-8"></div>
        </div>
      </div>
    </div>
  )
