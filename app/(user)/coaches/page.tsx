  ...
  return (
    <div>
      <div className="mb-12 md:mb-[72px]">
        <p className="lg:font-[family-name:var(--font-coiny)] font-[family-name:var(--font-roboto-condensed)] font-semibold lg:font-bold md:text-center text-ring text-2xl md:text-4xl mt-16 md:mt-16 lg:mt-[93px] mb-3.5 md:mb-7">
          Các HLV của Shefit
        </p>
