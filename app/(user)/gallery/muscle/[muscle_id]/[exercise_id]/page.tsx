    ...
    <div className="flex flex-col gap-10 mt-10">
      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-2 mb-5">
          ...
          <div className="text-[#737373] text-xl">{exerciseId.data?.[0].name}</div>
        </div>
        <div className="flex flex-col gap-2 mb-5">
          <div className="font-[family-name:var(--font-coiny)] text-text xl:text-[40px]">Thông tin bài tập</div>
          <div className="text-[#737373] text-xl">{exerciseId.data?.[0].description}</div>
        </div>
      </div>

      {exerciseId.data?.[0].equipments?.length > 0 && (
        <div className="flex flex-col gap-5">
          ...
          <ScrollArea className="w-screen-max-xl">
            <div className="flex space-x-4 py-4 w-full">
              {exerciseId.data[0].equipments.map((equipment, index) => (
      ...
      {exerciseId.data?.[0].muscle_groups?.length > 0 && (
        <div className="flex flex-col gap-5">
          ...
          <ScrollArea className="w-screen-max-xl">
            <div className="flex w-full space-x-4 py-4">
              {exerciseId.data[0].muscle_groups.map((muscleGroup, index) => (
