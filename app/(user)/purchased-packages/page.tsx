...
export default function PurchasesPackages() {
  ...
  return (
    <div className="py-16 px-5 md:py-16 md:px-10 lg:p-[60px] max-w-[1543px]">
      ...
      <div className="mb-7">
        <div className="text-3xl font-[Coiny] text-[#FF7873] mb-7">
          Gói 1: Easy Slim
        </div>
        ...
        <ul className="list-disc pl-7 text-[#737373] text-base md:text-xl mb-7">
          ...
          <li>
            ...
            7-10cm vòng eo, 𝐛𝐮̣𝐧𝐠 𝐝𝐮̛𝐨̛́𝐢 𝐩𝐡𝐚̆̉𝐧𝐠, tay & chân thon gọn, nhưng MÔNG
            không giảm mà cao săn chắc căng tròn.
          </li>
        </ul>
      ...
      <div className="mb-7">
        ...
        <ul className="list-disc pl-7 text-[#737373] text-base md:text-xl mb-7">
          ...
          <li>
            Dựa trên số đo 3 vòng, cân nặng & chiều cao, HLV Shefit phân tích
            phom dáng học viên (Quả Lê, Táo, Đồng Hồ Cát, Tam Giác Ngược, Chữ
            Nhật) biết được các phần hình thể nào cần tập trung để đạt Tone
            Body.
          </li>
          ...
          <li>
            Bí quyết nằm ở phối bài tập khoa học: đan xen Đốt Mỡ HIIT cường độ
            cao toàn thân và tập kháng lực nhiều vòng lặp Cắt Nét Cơ mông &
            bụng.
          </li>
          ...
          <li>
            Lượng calo, đạm, đường béo thực đơn dựa trên chỉ số của từng chị,
            đảm bảo dinh dưỡng giảm mỡ tăng cơ. Công thức món đơn giản dễ chuẩn
            bị hàng ngày.
          </li>
          ...
          <li>
            ...
            dưới hay Bột Cải Xoăn Organic bổ sung chất xơ, no lâu giảm cân (chọn
            1 trong 2)
          </li>
          ...
          <li>
            ...
            lộ đường cong thắt eo giảm 7-10cm, lên rãnh bụng 11, rãnh lưng S,
            đặc biệt MÔNG đào siêu cao tròn
          </li>
        </ul>
