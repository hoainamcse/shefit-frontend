interface FoodGrainsIconProps extends React.ComponentPropsWithoutRef<'svg'> {
  size?: number | string
  className?: string
}

export function FoodGrainsIcon({ size, style, className = '', ...others }: FoodGrainsIconProps) {
  return (
    <svg
