interface MemberShipIconProps extends React.ComponentPropsWithoutRef<'svg'> {
  size?: number | string
  className?: string
}

export function MemberShipIcon({ size, style, className = '', ...others }: MemberShipIconProps) {
  return (
    <svg
