interface ExerciseYogaIconProps extends React.ComponentPropsWithoutRef<'svg'> {
  size?: number | string
  className?: string
}

export function ExerciseYogaIcon({ size, style, className = '', ...others }: ExerciseYogaIconProps) {
  return (
    <svg
