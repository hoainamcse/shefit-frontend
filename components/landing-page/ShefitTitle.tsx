...
export default function Title() {
  return (
    <div className="relative mb-12">
      ...
      <div className="lg:absolute max-lg:relative lg:top-1/2 lg:left-2/3 max-lg:top-[200px] max-lg:lg-left-0 transform -translate-y-1/2 xl:w-[548px] gap-4 flex flex-col font-bold lg:bg-transparent max-lg:bg-primary max-lg:w-full max-lg:px-14 lg:px-0 max-lg:h-[400px] max-lg:text-center max-lg:justify-center lg:text-left">
