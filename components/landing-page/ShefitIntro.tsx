  ...
  return (
    <div className="mb-12 bg-white">
      ...
      <div className="xl:flex max-lg:block gap-10 items-center justify-between">
        <Image src={ImageIntro} alt="intro" className="xl:w-[1065px] max-lg:w-full max-lg:my-7" />
        <div className="max-lg:text-center px-12 max-lg:px-5 flex flex-col gap-10 max-lg:w-full max-lg:justify-center">
          <div className="flex flex-col gap-[16px] max-lg:w-full ">
            ...
            <p className="text-[20px] font-normal max-lg:text-[16px]">
              SHEFIT phân tích phom dáng chuyên sâu, xác định chính xác đặc điểm cơ thể, tạo nền tảng cho lộ trình
              &apos;độ&apos; dáng tối ưu.
            </p>
          </div>
          <div className="flex flex-col gap-[16px] max-lg:w-full">
            ...
            <p className="text-[20px] font-normal max-lg:text-[16px]">
              Kết hợp HIIT, LISS, Tabata và kháng lực, cùng các phương pháp Circuit, Supersets, AMRAP để cắt nét cơ toàn
              bộ cơ thể đồng thời đốt mỡ hiệu quả.
            </p>
          </div>
          <div className="flex flex-col gap-[16px] max-lg:w-full">
            <div className="flex item-center max-lg:w-full max-lg:justify-center ">
            ...
            <p className="text-[20px] font-normal max-lg:text-[16px]">
              Thực đơn từ bác sĩ dinh dưỡng, ngon, đủ chất, không cần ăn kiêng. Giảm mỡ, tăng cơ, duy trì vóc dáng bền
              vững.
            </p>
          </div>
